...
## 1. Project Overview
SALU Bus Tracker is an Android application designed for Shah Abdul Latif University to track university buses in real-time. The app serves three types of users: Students, Drivers, and Administrators. Created By Israr Brohi, A final year project.
